...
export default class Entity extends React.Component {
    ...
    get style() {
        return {
            ...
            width: Math.round(this.props.entity.width) + "px",
            height: Math.round(this.props.entity.height) + "px",
            top: Math.round(this.props.entity.position.y) + "px",
            left: Math.round(this.props.entity.position.x) + "px",
            marginTop: Math.round(-1 * this.props.entity.height) + "px",
            marginLeft: Math.round(-0.5 * this.props.entity.width) + "px",
